...
$insert3 = 'insert into `match` values ("1", "football", "Football", "Barcelona", "Real Madrid", "2016-08-20", "1", "1", "1");';

$insert4 = 'insert into `match` values ("2", "e-sport", "Starcraft 2", "Jaedong", "MMA", "2016-06-14", "1", "1", "1");';
